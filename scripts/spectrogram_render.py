...
sample_duration_sec_0 = 40 # 30.0 # [sec] Duration of track to sample, set = 0 to sample entire track
sample_offset = 0.0          # [sec] Offset into track to begin sample
sample_rate = 44100

fps = 5 # Rendered visualization framerate [default: 30]
dt = 1.0/fps # Delay between frames in seconds.
dt_ms = dt*1000.0; # Delay in milliseconds

num_hops_per_frame = 4 # 2
