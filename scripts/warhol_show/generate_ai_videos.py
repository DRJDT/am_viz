...
setlist = ['the_governors_dead']

negative_text_prompt = "cartoons drawings animations"
additional_positive_prompt = "ethereal tropical dreamscape"
...
for track_name in setlist:
    ...
    generated_frame_dir = track_dir + "generated_frame_images_2/"
    generated_vid_filename = track_dir + 'generated_vid_2.avi'
    generated_vid_with_audio_filename = track_dir + 'generated_vid_with_audio_2.avi'
   ...
   # GEN PARAMS: num_inference_steps = 40, strength = 0.2, text_prompt_weight = 0.5
    ...
    for frame_i in range(n_input_frames):
        ...
        text_prompt = text_prompt + ' ' + additional_positive_prompt
        ...
        for step_i,si in enumerate(steps):
            ...
            image = pipeline(text_prompt, image=last_image, num_inference_steps = 40, strength = 0.2, guidance_scale=text_prompt_weight, generator=generator,negative_prompt=negative_text_prompt).images[0]
